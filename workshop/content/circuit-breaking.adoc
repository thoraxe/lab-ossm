...
`user1-smcp` project (at the top) in order to find the URL for Jaeger.
...
[source,bash,role="execute-1"]
----
oc delete -n user1-tutorial virtualservice.networking.istio.io/recommendation destinationrule.networking.istio.io/recommendation
----