...
OpenShift using Service Mesh, an open platform to connect, manage, and secure
microservices.

## Background

Service Mesh is an open platform to connect, manage, and secure microservices. Service Mesh
...
a special sidecar proxy throughout your environment to enable Service Mesh
...
Service Mesh’s control plane functionality -- not your application code!
